...
export function DeveloperView() {
  ...
  const {name, login, created_at, avatar_url, bio,public_repos,followers,following, company, location, twitter_username,blog
...
console.log(data)
  return (<Styled.Wrapper>
    ...
    <Styled.SocialInfo>
      ...
      <Styled.SocialItem>
        <FaLink size="20px" />
        <Styled.SocialItemText as="a" href={blog}>{blog}</Styled.SocialItemText>
      </Styled.SocialItem>
      <Styled.SocialItem>
        <FaTwitter size="20px" />
